...
model_path = '../Model/sample_transliterationv2_1.keras'
...
class Transliteration2:
    ...
    def generate_one_hot_sequence(self, input_texts):
    ...
    def generate_one_hot_encoder_decoder(self):
        ...
        #         encoder_input_data[i, t, self.input_token_index[char]] = 1.
        #     encoder_input_data[i, t + 1:, self.input_token_index[' ']] = 1.
        encoder_input_data = self.generate_one_hot_sequence(self.input_texts)
    ...
    def create_encoder_model(self):
        ...
        encoder_inputs= Input(shape=(self.max_encoder_seq_length, self.num_encoder_tokens), name='encoder_inputs')

        masking_array = [0 for _ in range(self.max_encoder_seq_length)]
        masking_array[0] = 1
        ...
        self.model = model_encoder_training
    ...
    def load_encoding_decoding_models(self, encoding_model_path, decoding_model_path):
        self.encoder_model = keras.models.load_model(encoding_model_path)
        self.decoder_model = keras.models.load_model(decoding_model_path)

    def define_encoder_decoder_model(self):
    ...
    def decode_sequence(self, input_word):
        ...
        input_seq = self.generate_one_hot_sequence([input_word])
        ...
        while not stop_condition:
            ...
            if (sampled_token_index == 0 or sampled_token_index == 1 or
                    len(decoded_word) == self.max_decoder_seq_length):
                stop_condition = True
